...
public class AddUser extends javax.swing.JFrame
{
     ...
     */
    public AddUser() throws RemoteException, NotBoundException
    {
        initComponents();
    ...
    private void initComponents()
    {
        ...
        jLabel10.setBounds(465, 49, 140, 50);
        ...
        btnAddUser.setBounds(260, 410, 141, 35);
    ...
    {//GEN-HEADEREND:event_btnAddUserActionPerformed
        ...
        {
            Staff staff = new Staff(staffID, new Department(department, ""), name, surname, cellNo, email, new Address(0, city, suburb, street, port), new Login(0, username, password, false));
