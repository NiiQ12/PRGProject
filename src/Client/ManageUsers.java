...
public class ManageUsers extends javax.swing.JFrame
{
     ...
     */
    public ManageUsers() throws RemoteException, NotBoundException
    {
        initComponents();
        ...
        if (tblStaff.getSelectedRow() >= 0)
        {
            if (tblStaff.getValueAt(tblStaff.getSelectedRow(), 6).equals(false))
            {
                try
                {
                    ...
                    {
                        is.RegisterStaff((String) tblStaff.getValueAt(tblStaff.getSelectedRow(), 0));
                    }
    ...
    public void SetTableValues() throws RemoteException
    {
        try
        {
            List<Staff> staff = is.GetStaffFromDatabase(ct);
        ...
        if (tblStaff.getSelectedRow() >= 0)
        {
            if (tblStaff.getValueAt(tblStaff.getSelectedRow(), 6).equals(true))
            {
                try
                {
                    ...
                    {
                        is.UnregisterStaff((String) tblStaff.getValueAt(tblStaff.getSelectedRow(), 0));
                    }
                } catch (ClassNotFoundException ex)
                {
                    Logger.getLogger(ManageUsers.class.getName()).log(Level.SEVERE, null, ex);
