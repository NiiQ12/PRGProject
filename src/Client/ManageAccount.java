...
public class ManageAccount extends javax.swing.JFrame
{
     ...
     */
    public ManageAccount() throws RemoteException, NotBoundException
    {
        initComponents();
    ...
    {//GEN-HEADEREND:event_formWindowActivated
        ...
        try
        {
            staff = is.GetStaffFromDatabase(Staff.loggedInStaffID);
        } catch (SQLException ex)
        {
            Logger.getLogger(ManageAccount.class.getName()).log(Level.SEVERE, null, ex);
        } catch (ClassNotFoundException ex)
